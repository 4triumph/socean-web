!function(e) {
    ...
    i = function() {
        ...
        i.prototype.setSlideClasses = function(e) {
            ...
            t = n.$slider.find(".slick-slide").removeClass("slick-active slick-center slick-current").attr("aria-hidden", "true"),
                ...
                n.options.infinite === !0 && (e >= i && e <= n.slideCount - 1 - i ? n.$slides.slice(e - i, e + i + 1).addClass("slick-active").attr("aria-hidden", "false") : (o = n.options.slidesToShow + e,
    ...
    !function(e, i, t) {
        ...
        o.prototype.init = function() {
            var t, o, s = this, n = e(this.element), a = this.settings;
            if (a.duplicate ? s.mobileNav = n.clone() : s.mobileNav = n,
            a.removeIds && (s.mobileNav.removeAttr("id"),
                s.mobileNav.find("*").each(function(i, t) {
                    e(t).removeAttr("id")
                })),
            a.removeClasses && (s.mobileNav.removeAttr("class"),
                s.mobileNav.find("*").each(function(i, t) {
                    e(t).removeAttr("class")
                })),
            a.removeStyles && (s.mobileNav.removeAttr("style"),
                s.mobileNav.find("*").each(function(i, t) {
                    e(t).removeAttr("style")
                })),
                t = r + "_icon",
            "" === a.label && (t += " " + r + "_no-text"),
            "a" == a.parentTag && (a.parentTag = 'a href="#"'),
                s.mobileNav.attr("class", r + "_nav"),
                o = e('<div class="' + r + '_menu"></div>'),
            "" !== a.brand) {
                var d = e('<div class="' + r + '_brand">' + a.brand + "</div>");
                e(o).append(d)
            }
            s.btn = e(["<" + a.parentTag + ' aria-haspopup="true" role="button" tabindex="0" class="' + r + "_btn " + r + '_collapsed">', '<span class="' + r + '_menutxt">' + a.label + "</span>", '<span class="' + t + '">', '<span class="' + r + '_icon-bar"></span>', '<span class="' + r + '_icon-bar"></span>', '<span class="' + r + '_icon-bar"></span>', "</span>", "</" + a.parentTag + ">"].join("")),
                e(o).append(s.btn),
                "" !== a.appendTo ? e(a.appendTo).append(o) : e(a.prependTo).prepend(o),
                o.append(s.mobileNav);
            var c = s.mobileNav.find("li");
            e(c).each(function() {
                var i = e(this)
                    , t = {};
                if (t.children = i.children("ul").attr("role", "menu"),
                    i.data("menu", t),
                t.children.length > 0) {
                    var o = i.contents()
                        , n = !1
                        , l = [];
                    e(o).each(function() {
                        return !e(this).is("ul") && (l.push(this),
                            void (e(this).is("a") && (n = !0)))
                    });
                    var d = e("<" + a.parentTag + ' role="menuitem" aria-haspopup="true" tabindex="-1" class="' + r + '_item"/>');
                    if (a.allowParentLinks && !a.nestedParentLinks && n)
                        e(l).wrapAll('<span class="' + r + "_parent-link " + r + '_row"/>').parent();
                    else {
                        var c = e(l).wrapAll(d).parent();
                        c.addClass(r + "_row")
                    }
                    a.showChildren ? i.addClass(r + "_open") : i.addClass(r + "_collapsed"),
                        i.addClass(r + "_parent");
                    var p = e('<span class="' + r + '_arrow">' + (a.showChildren ? a.openedSymbol : a.closedSymbol) + "</span>");
                    a.allowParentLinks && !a.nestedParentLinks && n && (p = p.wrap(d).parent()),
                        e(l).last().after(p)
                } else
                    0 === i.children().length && i.addClass(r + "_txtnode");
                i.children("a").attr("role", "menuitem").click(function(i) {
                    a.closeOnClick && !e(i.target).parent().closest("li").hasClass(r + "_parent") && e(s.btn).click()
                }),
                a.closeOnClick && a.allowParentLinks && (i.children("a").children("a").click(function(i) {
                    e(s.btn).click()
                }),
                    i.find("." + r + "_parent-link a:not(." + r + "_item)").click(function(i) {
                        e(s.btn).click()
                    }))
            }),
                e(c).each(function() {
                    var i = e(this).data("menu");
                    a.showChildren || s._visibilityToggle(i.children, null, !1, null, !0)
                }),
                s._visibilityToggle(s.mobileNav, null, !1, "init", !0),
                s.mobileNav.attr("role", "menu"),
                e(i).mousedown(function() {
                    s._outlines(!1)
                }),
                e(i).keyup(function() {
                    s._outlines(!0)
                }),
                e(s.btn).click(function(e) {
                    e.preventDefault(),
                        s._menuToggle()
                }),
                s.mobileNav.on("click", "." + r + "_item", function(i) {
                    i.preventDefault(),
                        s._itemClick(e(this))
                }),
                e(s.btn).keydown(function(i) {
                    var t = i || event;
                    switch (t.keyCode) {
                        case l.ENTER:
                        case l.SPACE:
                        case l.DOWN:
                            i.preventDefault(),
                            t.keyCode === l.DOWN && e(s.btn).hasClass(r + "_open") || s._menuToggle(),
                                e(s.btn).next().find('[role="menuitem"]').first().focus()
                    }
                }),
                s.mobileNav.on("keydown", "." + r + "_item", function(i) {
                    var t = i || event;
                    switch (t.keyCode) {
                        case l.ENTER:
                            i.preventDefault(),
                                s._itemClick(e(i.target));
                            break;
                        case l.RIGHT:
                            i.preventDefault(),
                            e(i.target).parent().hasClass(r + "_collapsed") && s._itemClick(e(i.target)),
                                e(i.target).next().find('[role="menuitem"]').first().focus()
                    }
                }),
                s.mobileNav.on("keydown", '[role="menuitem"]', function(i) {
                    var t = i || event;
                    switch (t.keyCode) {
                        case l.DOWN:
                            i.preventDefault();
                            var o = e(i.target).parent().parent().children().children('[role="menuitem"]:visible')
                                , n = o.index(i.target)
                                , a = n + 1;
                            o.length <= a && (a = 0);
                            var d = o.eq(a);
                        ...
                        case l.LEFT:
                            if (i.preventDefault(),
                                e(i.target).parent().parent().parent().hasClass(r + "_open")) {
                                var c = e(i.target).parent().parent().prev();
                                c.focus(),
                                    s._itemClick(c)
                            } else
                                e(i.target).parent().parent().hasClass(r + "_nav") && (s._menuToggle(),
                                    e(s.btn).focus());
                            break;
                        case l.ESCAPE:
                            i.preventDefault(),
            ...
            o.prototype._menuToggle = function(e) {
                var i = this
                    , t = i.btn
                    , o = i.mobileNav;
                t.hasClass(r + "_collapsed") ? (t.removeClass(r + "_collapsed"),
                    t.addClass(r + "_open")) : (t.removeClass(r + "_open"),
                    t.addClass(r + "_collapsed")),
                    t.addClass(r + "_animating"),
                    i._visibilityToggle(o, t.parent(), !0, t)
            }
            ,
            o.prototype._itemClick = function(e) {
                var i = this
                    ...
                    , o = e.data("menu");
                o || (o = {},
                    o.arrow = e.children("." + r + "_arrow"),
                    o.ul = e.next("ul"),
                    o.parent = e.parent(),
                o.parent.hasClass(r + "_parent-link") && (o.parent = e.parent().parent(),
                    o.ul = e.parent().next("ul")),
                    e.data("menu", o)),
                    o.parent.hasClass(r + "_collapsed") ? (o.arrow.html(t.openedSymbol),
                        o.parent.removeClass(r + "_collapsed"),
                        o.parent.addClass(r + "_open"),
                        o.parent.addClass(r + "_animating"),
                        i._visibilityToggle(o.ul, o.parent, !0, e)) : (o.arrow.html(t.closedSymbol),
                        o.parent.addClass(r + "_collapsed"),
                        o.parent.removeClass(r + "_open"),
                        o.parent.addClass(r + "_animating"),
                        i._visibilityToggle(o.ul, o.parent, !0, e))
            }
            ,
            o.prototype._visibilityToggle = function(i, t, o, s, n) {
                function l(i, t) {
                    e(i).removeClass(r + "_animating"),
                        e(t).removeClass(r + "_animating"),
                    n || c.afterOpen(i)
                }
                function a(t, o) {
                    i.attr("aria-hidden", "true"),
                        ...
                        i.hide(),
                        e(t).removeClass(r + "_animating"),
                        e(o).removeClass(r + "_animating"),
                        n ? "init" == t && c.init() : c.afterClose(t)
                }
                var d = this
                    , c = d.settings
                    , p = d._getActionItems(i)
                    , u = 0;
                o && (u = c.duration),
                    i.hasClass(r + "_hidden") ? (i.removeClass(r + "_hidden"),
                    n || c.beforeOpen(s),
                        "jquery" === c.animations ? i.stop(!0, !0).slideDown(u, c.easingOpen, function() {
                            l(s, t)
                        }) : "velocity" === c.animations && i.velocity("finish").velocity("slideDown", {
                            duration: u,
                            easing: c.easingOpen,
                            complete: function() {
                                l(s, t)
                        ...
                        p.attr("tabindex", "0"),
                        d._setVisAttr(i, !1)) : (i.addClass(r + "_hidden"),
                    n || c.beforeClose(s),
                        "jquery" === c.animations ? i.stop(!0, !0).slideUp(u, this.settings.easingClose, function() {
                            a(s, t)
                        }) : "velocity" === c.animations && i.velocity("finish").velocity("slideUp", {
                            duration: u,
            ...
            ,
            o.prototype._setVisAttr = function(i, t) {
                var o = this
                    , s = i.children("li").children("ul").not("." + r + "_hidden");
                t ? s.each(function() {
                    var i = e(this);
                    i.attr("aria-hidden", "true");
                    var s = o._getActionItems(i);
                    s.attr("tabindex", "-1"),
                        o._setVisAttr(i, t)
                }) : s.each(function() {
                    var i = e(this);
            ...
            o.prototype._getActionItems = function(e) {
                ...
                if (!i) {
                    ...
                    var t = e.children("li")
                        , o = t.find("a");
                    i.links = o.add(t.find("." + r + "_item")),
                        e.data("menu", i)
                }
                return i.links
            }
            ,
            o.prototype._outlines = function(i) {
                i ? e("." + r + "_item, ." + r + "_btn").css("outline", "") : e("." + r + "_item, ." + r + "_btn").css("outline", "none")
            }
            ,
            ...
            e.fn[n] = function(i) {
                ...
                if ("string" == typeof i && "_" !== i[0] && "init" !== i) {
                    var s;
                    return this.each(function() {
                        var r = e.data(this, "plugin_" + n);
                        r instanceof o && "function" == typeof r[i] && (s = r[i].apply(r, Array.prototype.slice.call(t, 1)))
                    }),
                        void 0 !== s ? s : this
                }
            }
